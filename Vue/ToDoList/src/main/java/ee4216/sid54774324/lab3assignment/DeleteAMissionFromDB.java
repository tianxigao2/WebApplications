 ...
 * @author Jane G
 */
@WebServlet(name = "DeleteAMissionFromDB", urlPatterns = {"/delete"})
public class DeleteAMissionFromDB extends HttpServlet {
...
//        System.out.println(wholeStr);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(DeleteAMissionFromDB.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
